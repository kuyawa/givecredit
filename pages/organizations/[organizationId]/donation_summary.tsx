...
async function sendPayment(name, email, organization, amount, currency, issuer, destinTag, yesReceipt, yesNFT){
...
async function mintNFT(txid){
  ...
  const minted = await postApi('nft/mint', {txid})
...
export default function Donate({
  ...
  useEffect(() => {
    if (confirmed) {
      setConfirmed(false)
      sendPayment(name, email, organization, amount, currency, issuer, destinationTag, yesReceipt, yesNFT)
    }
